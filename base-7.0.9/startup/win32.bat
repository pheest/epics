...
call "%PROGRAM_FILES%\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvarsall.bat" x86_x64
...
REM --  win32-x86 ---
:X86
call "%PROGRAM_FILES%\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvarsall.bat" x86
